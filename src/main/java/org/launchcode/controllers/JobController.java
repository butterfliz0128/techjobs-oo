...
public class JobController {
    ...
    public String add(Model model, @Valid JobForm jobForm, Errors errors) {
        ...
        Job addJob = new Job(jobForm.getName(),
        ...
        Integer addJobId = addJob.getId();
        String strAddJobId = Integer.toString(addJobId);




        //model.addAttribute("job", addJob);

        return "redirect:?id=" + strAddJobId;
